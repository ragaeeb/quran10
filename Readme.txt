...
CREATE TABLE mentions (id INTEGER PRIMARY KEY, target INTEGER NOT NULL REFERENCES individuals(id) ON DELETE CASCADE ON UPDATE CASCADE, bio_id INTEGER NOT NULL REFERENCES biographies(id), points INTEGER, UNIQUE(target,bio_id) ON CONFLICT REPLACE);
