...
CREATE TABLE tahdeel (id INTEGER PRIMARY KEY, from_id INTEGER REFERENCES individuals(id) ON DELETE CASCADE ON UPDATE CASCADE, target INTEGER REFERENCES individuals(id) ON DELETE CASCADE ON UPDATE CASCADE, body TEXT, reference TEXT);
CREATE TABLE rudood (id INTEGER PRIMARY KEY, from_id INTEGER REFERENCES individuals(id) ON DELETE CASCADE ON UPDATE CASCADE, target INTEGER REFERENCES individuals(id) ON DELETE CASCADE ON UPDATE CASCADE, body TEXT, reference TEXT);
...
CREATE INDEX IF NOT EXISTS tahdeel_index ON tahdeel(from_id,target);
CREATE INDEX IF NOT EXISTS rudood_index ON rudood(from_id,target);
